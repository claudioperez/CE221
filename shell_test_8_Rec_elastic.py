...
def create_model(walk_edge=False):
    ...
    # ------------------
    #                            tag E   nu   h   rho
    model.section("ElasticShell", 1, E, 0.25, 12, 1.27)
...
# ---- write nodal displacements to CSV ----
with open('node_displacements_rec.csv', 'w', newline='') as f_disp:
...
with open('node_coordinates_rec.csv', 'w', newline='') as f_coord:
...
print("Wrote node_displacements.csv and node_coordinates.csv")
